...
{
    public partial class ChartsViewModel(ICommandDispatcher commandDispatcher, IErrorVisualizerService errorVisualizerService) : ObservableObject, ICancellable
    {
